create table inv_unit_inv_unit_fcy_visit with (PARTITIONS=16) as 
select
inv_unit_gkey,
inv_unit_id,
...
ufv_operation,
ufv_timestamp
from inv_unit left join inv_unit_fcy_visit on inv_unit_active_ufv_fk = ufv_multi_tenant_pk;

CREATE STREAM inv_unit_inv_unit_fcy_visit_stream
(
...
ufv_timestamp varchar) WITH (KAFKA_TOPIC='INV_UNIT_INV_UNIT_FCY_VISIT',VALUE_FORMAT='JSON');


CREATE STREAM inv_unit_inv_unit_fcy_visit_stream_rekeyed with(PARTITIONS=16) AS select
inv_unit_gkey,
inv_unit_id,
inv_unit_foreignhost_key,
inv_unit_visit_state,
...
case when ufv_multi_tenant_pk is null then '0' else ufv_multi_tenant_pk end as ufv_multi_tenant_pk,
ufv_operation,
ufv_timestamp FROM inv_unit_inv_unit_fcy_visit_stream PARTITION BY inv_unit_active_ufv_fk;


CREATE TABLE inv_unit_inv_unit_fcy_visit_rekeyed (
inv_unit_gkey varchar,
inv_unit_id varchar,
inv_unit_foreignhost_key varchar,
inv_unit_visit_state varchar,
...
) WITH (KAFKA_TOPIC='INV_UNIT_INV_UNIT_FCY_VISIT_STREAM_REKEYED',VALUE_FORMAT='JSON',KEY='inv_unit_active_ufv_fk');