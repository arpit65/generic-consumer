create table inv_unit_ufv_uyv_ref_equip_ref_equip_type with (PARTITIONS=16)as
select
inv_unit_gkey,
inv_unit_id,
...
refeqty_operation,
refeqty_timestamp,
refeqty_multi_tenant_pk from inv_unit_ufv_uyv_rekeyed left join ref_equipment_ref_equip_type on inv_unit_eq_gkey_fk = refeq_multi_tenant_pk;

create stream inv_unit_ufv_uyv_ref_equip_ref_equip_type_stream (
...
) WITH (KAFKA_TOPIC='INV_UNIT_UFV_UYV_REF_EQUIP_REF_EQUIP_TYPE',VALUE_FORMAT='JSON');

create stream inv_unit_ufv_uyv_ref_equip_ref_equip_type_stream_rekeyed with (PARTITIONS=16)as
select
inv_unit_gkey,
inv_unit_id,
inv_unit_foreignhost_key,
...
refeqty_operation,
refeqty_timestamp,
refeqty_multi_tenant_pk from INV_UNIT_UFV_UYV_REF_EQUIP_REF_EQUIP_TYPE_STREAM partition by inv_unit_goods_fk;


create table inv_unit_ufv_uyv_ref_equip_ref_equip_type_rekeyed (
inv_unit_gkey varchar,
inv_unit_id varchar,
inv_unit_foreignhost_key varchar,
inv_unit_visit_state varchar,
...
refeqty_timestamp varchar,
refeqty_multi_tenant_pk varchar
) WITH (KAFKA_TOPIC='INV_UNIT_UFV_UYV_REF_EQUIP_REF_EQUIP_TYPE_STREAM_REKEYED',VALUE_FORMAT='JSON',KEY='inv_unit_goods_fk');