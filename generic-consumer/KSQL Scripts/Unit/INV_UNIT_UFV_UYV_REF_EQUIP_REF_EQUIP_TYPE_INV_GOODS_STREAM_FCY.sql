create stream INV_UNIT_UFV_UYV_REF_EQUIP_REF_EQUIP_TYPE_INV_GOODS_STREAM_REKEYED_FCY with (PARTITIONS=16) as 
select
inv_unit_gkey,
inv_unit_id,
...
fcy_multi_tenant_pk 
from INV_UNIT_UFV_UYV_REF_EQUIP_REF_EQUIP_TYPE_INV_GOODS_STREAM_REKEYED left join argo_facility on ufv_fcy_gkey_fk = fcy_multi_tenant_pk partition by inv_unit_multi_tenant_pk;