create stream INV_UNIT_UFV_UYV_REF_EQUIP_REF_EQUIP_TYPE_INV_GOODS_STREAM_REKEYED_FCY_CPX_BIZ with (PARTITIONS=16) as 
select
inv_unit_gkey,
inv_unit_id,
...
biz_is_eq_owner,
biz_is_eq_operator,
biz_life_cycle_state,
biz_credit_status,
biz_per_unit_guarantee_limit,
biz_notes,
biz_ct_name,
biz_address_line1,
biz_address_line2,
...
biz_changed,
biz_changer,
biz_CUSTDFF_TV_APPT_QUOTA,
biz_reference_set_fk,
biz_state_gkey_fk,
biz_country_code_fk,
biz_bizu_gkey_fk,
biz_multi_tenant_pk,
biz_operation,
biz_timestamp 
from INV_UNIT_UFV_UYV_REF_EQUIP_REF_EQUIP_TYPE_INV_GOODS_STREAM_REKEYED_FCY_CPX left join ref_bizunit_scoped on inv_unit_line_op_fk = biz_multi_tenant_pk partition by inv_unit_multi_tenant_pk;